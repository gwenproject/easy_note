...
func (p *CreateNoteRequest) Field1DeepEqual(src int64) bool {
...
func (p *CreateNoteRequest) Field3DeepEqual(src string) bool {
...
func (p *UpdateNoteRequest) Field2DeepEqual(src *string) bool {
...
type QueryNoteRequest struct {
	...
	Current  int64   `thrift:"current,3" frugal:"3,default,i64" json:"current"`
...
var QueryNoteRequest_Keyword_DEFAULT string

func (p *QueryNoteRequest) GetKeyword() (v string) {
	if !p.IsSetKeyword() {
		return QueryNoteRequest_Keyword_DEFAULT
	}
	return *p.Keyword
}

func (p *QueryNoteRequest) GetCurrent() (v int64) {
	return p.Current
}

func (p *QueryNoteRequest) GetPageSize() (v int64) {
	return p.PageSize
}
func (p *QueryNoteRequest) SetUserId(val int64) {
	p.UserId = val
}
func (p *QueryNoteRequest) SetKeyword(val *string) {
	p.Keyword = val
}
func (p *QueryNoteRequest) SetCurrent(val int64) {
	p.Current = val
}
func (p *QueryNoteRequest) SetPageSize(val int64) {
	p.PageSize = val
}
...
func (p *QueryNoteRequest) IsSetKeyword() bool {
...
func (p *QueryNoteRequest) writeField3(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("current", thrift.I64, 3); err != nil {
		goto WriteFieldBeginError
	}
